...
static const RecipeNameMap recipe_name_map[] = {
    ...
    { "RECIPE_STONE_BRICK", RECIPE_STONE_BRICK },

    { "RECIPE_GREEN_CHIP", RECIPE_GREEN_CHIP },

    { "RECIPE_CRAFTER_1", RECIPE_CRAFTER_1 },
    { "RECIPE_BURNER_MINER", RECIPE_BURNER_MINER },
...
static const ItemTypeMap item_type_map[] = {
    ...
    { "ITEM_STONE_BRICK", ITEM_STONE_BRICK },

    { "ITEM_GREEN_CHIP", ITEM_GREEN_CHIP },

    { "ITEM_CRAFTER_1", ITEM_CRAFTER_1 },
    { "ITEM_BURNER_MINER", ITEM_BURNER_MINER },
